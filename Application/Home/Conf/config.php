...
return array(
  ...
  'HTML_CACHE_RULES'    => array(
      'Index:index' => array('{:module}_{:controller}_{:action}', 3600),
      'Article:detail' => array('{:module}_{:controller}_{:action}_{id}', 3600),
      'Article:index' => array('{:module}_{:controller}_{:action}_{category}', 3600),
  ),
