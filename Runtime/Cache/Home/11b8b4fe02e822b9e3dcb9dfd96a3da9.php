    ...
    <div class="vip_main">
        <div class="vip_main1">
            <div style="width: 200px;height: 80px;border-bottom:1px dashed #e1e1e1;text-align:center;line-height:80px;margin:0 auto;">
                <a href="<?php echo U('Login/vip');?>" style="text-decoration: none;font-size:18px;color:#ff7500">账户设置</a>
            </div>
            <div style="width: 200px;height: 80px;border-bottom:1px dashed #e1e1e1;text-align:center;line-height:80px;margin:0 auto;">
                <a href="<?php echo U('Vip/vipint');?>" style="text-decoration: none;font-size:18px;">会员积分</a>
            </div>
            <div style="width: 200px;height: 80px;border-bottom:1px dashed #e1e1e1;text-align:center;line-height:80px;margin:0 auto;">
                <a href="<?php echo U('Vip/mymoney');?>" style="text-decoration: none;font-size:18px;">我的钱包</a>
            </div>
            <div style="width: 200px;height: 80px;border-bottom:1px dashed #e1e1e1;text-align:center;line-height:80px;margin:0 auto;">
        ...
        <div class="vip_main2">
            <h2 style="text-align:center;color:#ff9102">个人信息</h2><hr>
            <form action="<?php echo U('Login/user_index');?>" enctype="multipart/form-data" method="post">
                <div class="vip_main2_l">
				<b>在此上传您的头像</b><br>
                    <div id="preview" style="height:260px;border: 1px dashed #b8cadd;background: url(/Public/Home/images/upload_bg.jpg) center no-repeat #f7fbff;"><img src="<?php echo ($list["pic"]); ?>"></div><br>
                    <input type="file" name="t123" onchange="previewImage(this)" />       
                </div>
				<div style="float: left;margin-left: 50px;border-left: 1px dashed #c6baba;">
                <div class="vip_main2_r">
                    <div style="height: 40px;"></div>
                    <li> <label>用户名：</label><input type="text" name="name" disabled="" value="<?php echo ($list["username"]); ?>" class="vipming" /> </li>
                    <li class="sex"> <label>性别：</label>&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="xingbie" value="1" class="check" <?php if(($list['sex'] == 1)): ?>checked<?php else: endif; ?> /> 男 &nbsp;&nbsp;&nbsp;
                        <input type="radio" name="xingbie" value="0" class="check" <?php if(($list['sex'] == 0)): ?>checked<?php else: endif; ?> /> 女 
                    </li>
                    <li><label>Q&nbsp; Q：&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" name="qqid" value="<?php echo ($list["qq"]); ?>" class="vipqq" /></li>
                    <li><label>电话：&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" name="phonenumber" value="<?php echo ($list["phone"]); ?>" class="vipphone" /></li>
                    <input class="" type="hidden" name="userid" value="<?php echo ($list["id"]); ?>" >
                    <li>
                    </li><br><br>
                    
                </div>
				</div>
				<input type="submit" value="保&nbsp;&nbsp;&nbsp;存" class="message_btn" style="margin-top: 40px;margin-left: 430px;margin-bottom: 20px;"/>
            </form>    
        </div>
    </div>
    <script type="text/javascript" src="/Public/Home/js/tupian.js"></script>    
